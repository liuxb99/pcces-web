...
public class FormSubFinalInput : Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Archnowledge.Pcces.PccesMain.SubFinal.FormSubFinalInput));
		...
		popupMenuTool7.SharedProps.Caption = "編輯決算數量/金額";
		...
		base.Name = "FormSubFinalInput";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "自行輸入數量/金額";
		base.WindowState = System.Windows.Forms.FormWindowState.Maximized;
		base.FormClosed += new System.Windows.Forms.FormClosedEventHandler(FormSubFinalInput_FormClosed);
		base.Load += new System.EventHandler(FormSubFinalInput_Load);
	...
	private void FormSubFinalInput_Load(object sender, EventArgs e)
	{
		ls_Queue = F_Queue;
		SettingDecimal();
		LoadData();
	...
	private void LoadData()
	{
		...
		MfqDT = MfqCom.ListFinalItem("", ls_Queue, ls_subproj, ls_prjcode);
		MfqCom = null;
		if (lb_Lock)
		{
		}
	...
	private void FormSubFinalInput_FormClosed(object sender, FormClosedEventArgs e)
	{
		base.DialogResult = DialogResult.OK;
	}
}
