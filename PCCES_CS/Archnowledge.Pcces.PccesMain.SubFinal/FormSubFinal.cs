...
public class FormSubFinal : Form
{
	...
	private PccesFormAction F_ActionName = PccesFormAction.SubFinal;
	...
	private string F_FunctionName = "SUBFINAL";
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Archnowledge.Pcces.PccesMain.SubFinal.FormSubFinal));
		...
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool3 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuReGen");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool4 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuIssueList");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool5 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuPickBudItem");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool6 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuCalcuInv");
		...
		Infragistics.Win.UltraWinToolbars.PopupMenuTool popupMenuTool4 = new Infragistics.Win.UltraWinToolbars.PopupMenuTool("mnuHelp");
		Infragistics.Win.Appearance appearance15 = new Infragistics.Win.Appearance();
		Infragistics.Win.Appearance appearance16 = new Infragistics.Win.Appearance();
		Infragistics.Win.UltraWinToolbars.PopupMenuTool popupMenuTool5 = new Infragistics.Win.UltraWinToolbars.PopupMenuTool("mnuFile_CNT");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool8 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuSwitchProj");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool9 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuPrint");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool10 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuFile_Digital");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool11 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuClose");
		Infragistics.Win.UltraWinToolbars.PopupMenuTool popupMenuTool6 = new Infragistics.Win.UltraWinToolbars.PopupMenuTool("mnuEdit_CNT");
		...
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool12 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuReGen");
		Infragistics.Win.UltraWinToolbars.PopupMenuTool popupMenuTool8 = new Infragistics.Win.UltraWinToolbars.PopupMenuTool("mnuView_CNT");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool13 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuIssueList");
		Infragistics.Win.UltraWinToolbars.PopupMenuTool popupMenuTool9 = new Infragistics.Win.UltraWinToolbars.PopupMenuTool("mnuTool_CNT");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool14 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuSwitchProj");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool15 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuPrint");
		Infragistics.Win.Appearance appearance17 = new Infragistics.Win.Appearance();
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool16 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuClose");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool17 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuApprove");
		Infragistics.Win.Appearance appearance18 = new Infragistics.Win.Appearance();
		Infragistics.Win.UltraWinToolbars.PopupMenuTool popupMenuTool10 = new Infragistics.Win.UltraWinToolbars.PopupMenuTool("mnuCalcu");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool18 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuCalcuInv");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool19 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuCalcuCnt");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool20 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuCalcuInput");
		...
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool23 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuReGen");
		Infragistics.Win.Appearance appearance19 = new Infragistics.Win.Appearance();
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool24 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuUndoApprove");
		Infragistics.Win.Appearance appearance20 = new Infragistics.Win.Appearance();
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool25 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuIssueList");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool26 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuReCal");
		...
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool27 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuAbout");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool28 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuUpdateList");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool29 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuAbout");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool30 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuCalcuInput");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool31 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuUpdateList");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool32 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuPickBudItem");
		Infragistics.Win.UltraWinToolbars.ButtonTool buttonTool33 = new Infragistics.Win.UltraWinToolbars.ButtonTool("mnuFile_Digital");
		...
		ultraToolbar1.Tools.AddRange(new Infragistics.Win.UltraWinToolbars.ToolBase[16]
		{
			...
			stateButtonTool3, stateButtonTool4, stateButtonTool5, stateButtonTool6, stateButtonTool7, stateButtonTool8
		});
		ultraToolbar2.DockedColumn = 0;
		ultraToolbar2.DockedRow = 0;
		ultraToolbar2.IsMainMenuBar = true;
		ultraToolbar2.Text = "Menu1";
		ultraToolbar2.Tools.AddRange(new Infragistics.Win.UltraWinToolbars.ToolBase[4] { popupMenuTool1, popupMenuTool2, popupMenuTool3, popupMenuTool4 });
		...
		popupMenuTool5.SharedProps.Caption = "檔案(&F)";
		...
		popupMenuTool5.Tools.AddRange(new Infragistics.Win.UltraWinToolbars.ToolBase[4] { buttonTool8, buttonTool9, buttonTool10, buttonTool11 });
		popupMenuTool6.SharedProps.Caption = "編輯(&E)";
		...
		popupMenuTool6.Tools.AddRange(new Infragistics.Win.UltraWinToolbars.ToolBase[2] { popupMenuTool7, buttonTool12 });
		popupMenuTool8.SharedProps.Caption = "檢視(&V)";
		popupMenuTool8.SharedProps.Category = "合約";
		popupMenuTool8.Tools.AddRange(new Infragistics.Win.UltraWinToolbars.ToolBase[1] { buttonTool13 });
		popupMenuTool9.SharedProps.Caption = "工具(&T)";
		popupMenuTool9.SharedProps.Category = "合約";
		buttonTool14.SharedProps.Caption = "切換專案...";
		buttonTool14.SharedProps.Category = "合約";
		appearance17.Image = resources.GetObject("appearance17.Image");
		buttonTool15.SharedProps.AppearancesSmall.Appearance = appearance17;
		buttonTool15.SharedProps.Caption = "列印報表...";
		buttonTool15.SharedProps.Category = "合約";
		buttonTool15.SharedProps.DisplayStyle = Infragistics.Win.UltraWinToolbars.ToolDisplayStyle.ImageOnlyOnToolbars;
		buttonTool16.SharedProps.Caption = "結束決算功能";
		...
		buttonTool17.SharedProps.Caption = "核定結算";
		buttonTool17.SharedProps.Category = "編輯";
		buttonTool17.SharedProps.DisplayStyle = Infragistics.Win.UltraWinToolbars.ToolDisplayStyle.ImageAndText;
		popupMenuTool10.SharedProps.Caption = "編輯決算數量/金額";
		popupMenuTool10.SharedProps.Category = "編輯";
		buttonTool20.InstanceProps.IsFirstInGroup = true;
		popupMenuTool10.Tools.AddRange(new Infragistics.Win.UltraWinToolbars.ToolBase[3] { buttonTool18, buttonTool19, buttonTool20 });
		buttonTool21.SharedProps.Caption = "填入估驗數量/金額";
		buttonTool21.SharedProps.Category = "編輯";
		buttonTool21.SharedProps.DisplayStyle = Infragistics.Win.UltraWinToolbars.ToolDisplayStyle.TextOnlyAlways;
		buttonTool22.SharedProps.Caption = "填入契約數量/金額";
		buttonTool22.SharedProps.Category = "編輯";
		...
		buttonTool23.SharedProps.Caption = "重新產生資料";
		buttonTool23.SharedProps.Category = "編輯";
		...
		buttonTool24.SharedProps.AppearancesSmall.Appearance = appearance20;
		buttonTool24.SharedProps.Caption = "取消核定";
		...
		buttonTool25.SharedProps.Caption = "各期估驗彙整查詢...";
		buttonTool25.SharedProps.Category = "檢視";
		...
		buttonTool26.SharedProps.AppearancesSmall.Appearance = appearance21;
		buttonTool26.SharedProps.Caption = "重新總計";
		buttonTool26.SharedProps.Category = "檢視";
		...
		popupMenuTool11.Tools.AddRange(new Infragistics.Win.UltraWinToolbars.ToolBase[2] { buttonTool27, buttonTool28 });
		buttonTool29.SharedProps.Caption = "關於PCCES...";
		buttonTool30.SharedProps.Caption = "自行輸入數量/金額...";
		buttonTool30.SharedProps.Category = "編輯";
		buttonTool31.SharedProps.Caption = "最新消息...";
		buttonTool32.SharedProps.Caption = "挑選自辦項目...";
		...
		buttonTool33.SharedProps.AppearancesSmall.Appearance = appearance22;
		buttonTool33.SharedProps.Caption = "製作電子檔...";
		buttonTool33.SharedProps.Category = "合約";
		buttonTool33.SharedProps.DisplayStyle = Infragistics.Win.UltraWinToolbars.ToolDisplayStyle.ImageOnlyOnToolbars;
		...
		this.ultraToolbarsManager1.Tools.AddRange(new Infragistics.Win.UltraWinToolbars.ToolBase[30]
		{
			popupMenuTool5, popupMenuTool6, popupMenuTool8, popupMenuTool9, buttonTool14, buttonTool15, buttonTool16, buttonTool17, popupMenuTool10, buttonTool21,
			buttonTool22, buttonTool23, buttonTool24, buttonTool25, buttonTool26, popupMenuTool11, buttonTool29, buttonTool30, buttonTool31, buttonTool32,
			buttonTool33, labelTool2, stateButtonTool9, stateButtonTool10, stateButtonTool11, stateButtonTool12, stateButtonTool13, stateButtonTool14, stateButtonTool15, stateButtonTool16
		});
		...
		appearance23.ImageBackground = (System.Drawing.Image)resources.GetObject("appearance11.ImageBackground");
		this.Btn_Splt.Appearance = appearance23;
		this.Btn_Splt.BackColor = System.Drawing.Color.LightGray;
		...
		this.ultraStatusBar1.Appearance = appearance26;
		...
		this.lblProjectData.Appearance = appearance28;
		...
		appearance30.BackColor = System.Drawing.Color.Silver;
		appearance30.BackColor2 = System.Drawing.Color.FromArgb(224, 224, 224);
		...
		this.BtnSwitchProject.Appearance = appearance30;
		...
		appearance31.BackColor = System.Drawing.Color.FromArgb(224, 224, 224);
		...
		this.BtnSwitchProject.HotTrackAppearance = appearance31;
		...
		base.Name = "FormSubFinal";
		this.Text = "契約決算";
		base.Load += new System.EventHandler(FormSubFinal_Load);
		base.Resize += new System.EventHandler(FormSubFinal_Resize);
	...
	private void FormSubFinal_Resize(object sender, EventArgs e)
	{
	...
	private void FormSubFinal_Load(object sender, EventArgs e)
	{
		HideCols(IsHide: true);
		FormSubFinal_Resize(null, null);
		SettingDecimal();
		RememberColsProps();
		base.ParentForm.Text = "PCCES Win 4.3 【契約決算】";
		...
		functionButtons1._ActiveFunction = "SUBFINAL";
	...
	private void LoadData()
	{
		...
		MfqCom.ps_final = "F";
		DT1 = MfqCom.ListFinalItem("", ls_Queue, ls_subproj, ls_prjcode);
		MfqCom = null;
		BindToGrid();
	}
	...
	private void BindToGrid()
	{
		...
		for (int i = 0; i < DT1.Rows.Count; i++)
		{
			...
			double Diff = PubTools.Str2Double(DT1.Rows[i]["Acc_Amt"]) - PubTools.Str2Double(DT1.Rows[i]["itemqty"]) * PubTools.Str2Double(DT1.Rows[i]["itemcost"]);
	...
	private void DoMenuAction(string MenuID)
	{
		...
		case "mnuPickBudItem":
		{
			FormSubFinal_ItemPick FM_ITM_PICK = new FormSubFinal_ItemPick();
			FM_ITM_PICK._ProjectCode = F_ProjectCode;
			FM_ITM_PICK._ActionName = F_ActionName;
			FM_ITM_PICK._UserID = F_UserID;
			FM_ITM_PICK._DT1 = DT1;
			FM_ITM_PICK.ShowDialog();
			FM_ITM_PICK.Close();
			FM_ITM_PICK.Dispose();
			FM_ITM_PICK = null;
			LoadData();
	...
	private void Execute_SubFinalInput()
	{
		FormSubFinalInput FM_CLS_INP = new FormSubFinalInput();
	...
	private void DoReCal(string IsMessage)
	{
		try
		{
			...
			DT1 = AccCom.ReTotal2(DT1, ls_Queue, F_SubProjetCode, F_ProjectCode);
			submfq MfqCom = new submfq(tmp_AL1);
	...
	private void Do_UndoApprove()
	{
		ArrayList tmp_AL1 = new ArrayList();
		tmp_AL1.Add(F_UserID);
		tmp_AL1.Add("(SubFinal) 契約結算--核定結算");
	...
	private void Do_CalcuInv()
	{
		...
		ArrayList tmp_AL1 = new ArrayList();
		tmp_AL1.Add(F_UserID);
		tmp_AL1.Add("(SubFinal) 契約結算--計算(填入估驗數量/金額)");
		submfq MfqCom = new submfq(tmp_AL1);
	...
	private void Do_CalcuCnt()
	{
		...
		ArrayList tmp_AL1 = new ArrayList();
		tmp_AL1.Add(F_UserID);
		tmp_AL1.Add("(SubFinal) 契約結算--計算(填入契約數量/金額)");
		submfq MfqCom = new submfq(tmp_AL1);
		DataTable MfqDT = MfqCom.ListCloseItem("", ls_Queue, ls_subproj, ls_prjcode);
		foreach (DataRow dr in MfqDT.Rows)
		{
			...
			double ld_Amt = PubTools.ARound(ld_qty * ld_cost, 2L);
	...
	private void ReGenData()
	{
		...
		if (MessageBox.Show(this, l_Message, "詢問", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
		{
			...
			ArrayList tmp_AL1 = new ArrayList();
			tmp_AL1.Add(F_UserID);
			tmp_AL1.Add("(SubFinal) 契約算--重新產生資料");
			sub_acc AccCom = new sub_acc(tmp_AL1);
